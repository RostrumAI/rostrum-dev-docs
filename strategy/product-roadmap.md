...
| --- | --- | --- | --- |
| M2 | A workflow can execute locally | [E2.1](../epics/m2/e2-1-establish-daemon-network-boundary.md), [E2.2](../epics/m2/e2-2-execute-sequential-workflows.md), [E2.3](../epics/m2/e2-3-execute-conditional-workflows.md), [E2.4](../epics/m2/e2-4-execute-parallel-paths-and-joins.md), [E2.5](../epics/m2/e2-5-execute-bounded-loops.md), and [E2.6](../epics/m2/e2-6-complete-m2-conformance.md) | A caller invokes an exact workflow publication through the Control API, disconnects, and later retrieves progress, output, or failures. One daemon supports independent concurrent runs, including repeated invocations of the same publication, and every M2 control-flow construct. Authors can choose whether eligible loop iteration errors stop execution or remain in ordered results. E2.6 demonstrates this across the separately deployable Control API and daemon, using private authenticated HTTP and independent connections to the same Postgres database. |
| M3 | A run can survive, wait, and be inspected | [E3.1](../epics/m3/e3-1-recover-durable-runs.md), [E3.2](../epics/m3/e3-2-retry-bounded-failures.md), [E3.3](../epics/m3/e3-3-pause-resume-and-cancel-runs.md), [E3.4](../epics/m3/e3-4-wait-for-human-decisions.md), [E3.5](../epics/m3/e3-5-inspect-run-timelines.md), [E3.6](../epics/m3/e3-6-retrieve-run-artifacts.md), and [E3.7](../epics/m3/e3-7-complete-m3-conformance.md) | A run survives daemon restart and client reconnect, exposes committed progress, attempts, events, and artifacts, retries bounded failures, pauses or cancels at recoverable boundaries, and waits for one validated human decision before continuing its selected path. |
