...
Depends on: [E2.1](e2-1-establish-daemon-network-boundary.md), [Workflow interface v1](../../specifications/workflow-interface-v1.md), its validator, and immutable workflow publications
