...
- One command demonstrates separate-network authenticated services, shared-database access, the Epic 1 failure cases, and clean shutdown and cleanup.
